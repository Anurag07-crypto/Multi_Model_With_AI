...
pg = st.navigation(
    [
        st.Page("page1.py", title="Chat With Bot", icon="🏠"),
        st.Page("page2.py", title="Leaf Classifier", icon="⚙️"),
        st.Page("page3.py", title="Real vs Ai image Identifier", icon="📊"),
        st.Page("page4.py", title="Indian Bird Classifier", icon="📊"),
    ]
)
pg.run()
with col_1:
